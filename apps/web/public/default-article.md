...
::: code-frame{lang="ts" title="组件语法示例"}
**组件语法示例** `ts`

```ts
// 组件语法：::: type{props} ... :::
const example = `::: quote-card{author="设计师"}
约束是创造力的朋友。
:::`;
```
