/**
 * CSS var() 函数解析原语（迁移自 apps/web/src/services/cssVarParser.ts）
 * 供 core 包内 ThemeProcessor、expandCSSVariables 共用，web 侧 inlineStyleVarResolver
 * 继续通过 core 入口或原路径 re-export 引用。
 */
