...
export function renderTokenCss(
  ...
  return [
    ...
    `  --wemd-h1-font-weight: ${typography.heading.h1.fontWeight};`,
    ...
    `  --wemd-h2-font-weight: ${typography.heading.h2.fontWeight};`,
    ...
    `  --wemd-h3-font-weight: ${typography.heading.h3.fontWeight};`,
    ...
    `  --wemd-h4-font-weight: ${typography.heading.h4.fontWeight};`,
    `  /* 圆角 */`,
